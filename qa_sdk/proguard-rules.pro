...
-keep class com.quantactions.sdk.data.model.TrendHolder.** { *; }
-keep class com.quantactions.sdk.data.model.SleepSummary
-keep class com.quantactions.sdk.data.model.TrendHolder
...
-keep class com.quantactions.sdk.data.model.JournalEntryEvent {
    public <methods>;
}
...
-keep class com.quantactions.sdk.Subscription {
    public <methods>;
}
...
-keep class com.quantactions.sdk.exceptions.QASDKException {
    *;
}
...
-keep class com.quantactions.sdk.data.api.adapters.SubscriptionWithQuestionnaires { *; }
-keep class com.quantactions.sdk.Subscription { *; }
